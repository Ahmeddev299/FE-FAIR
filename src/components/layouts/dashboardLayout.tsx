...
export const DashboardLayout: React.FC<DashboardLayoutProps> = ({ children }) => {
  ...
  const navigation = [
    ...
    { name: 'Upload Lease', href: '/news-alerts', icon: '/img3.png', current: router.pathname === '/news-alerts' },
    { name: 'Clause Management', href: '/bills', icon: '/img4.png', current: router.pathname === '/bills' },
