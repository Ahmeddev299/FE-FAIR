            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              <div>
                <Field
                  ...
                  className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
                <ErrorMessage name="premisses_property_city" component="div" className="text-sm text-red-500 mt-1" />
              </div>
              ...
              <div>
                ...
                <ErrorMessage name="premisses_property_state" component="div" className="text-sm text-red-500 mt-1" />
              </div>
              ...
              <div>
                <Field
                  ...
                  className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
                <ErrorMessage name="premisses_property_zip" component="div" className="text-sm text-red-500 mt-1" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium mb-2">
                Rentable SF <span className="text-xs text-gray-500">(optional)</span>
              </label>
              <Field
                name="rentable_sf"
                type="number"
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-green-700 mt-1">
              Accurate property address and any exclusive parking details help calculate rent and operating expenses.
            </p>
          </div>
        </div>
      </div>
