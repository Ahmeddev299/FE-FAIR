          ...
          <div className="px-6 pb-3 flex items-center gap-3">
            ...
            <div className="ml-auto flex items-center gap-2">
              ...
              <button
                ...
                onClick={handleDownload}
                disabled={isDownloadingLoi || downloadingRef.current}
                className="inline-flex items-center gap-2 h-9 px-4 rounded-md border border-gray-300 text-gray-800 hover:bg-gray-50 text-sm disabled:opacity-60 disabled:cursor-not-allowed"
              >
                <DownloadIcon className="w-4 h-4" />
                {isDownloadingLoi ? "Downloading…" : "Download"}
              </button>
