            ...
            <div className="min-h-screen">
                ...
                <div className="max-w-7xl mx-auto px-4 py-6 grid grid-cols-1 lg:grid-cols-12 gap-6">
                    ...
                    <div className="lg:col-span-8 bg-white rounded-lg shadow-sm border border-gray-200">
                        ...
                        {/* Document Content */}
                        <div className="p-8 bg-white w-full max-w-4xl mx-auto" style={{ transform: `scale(${zoom / 100})`, transformOrigin: 'top center' }}>
                            {/* Document Title */}
                            <div className="text-center mb-6">
                                <h2 className="font-semibold text-xl text-gray-800">COMMERCIAL LEASE AGREEMENT</h2>
                                <p className="text-sm text-gray-600 mt-2">Page 12 of 12</p>
                            </div>
                            ...
                            <div className="mt-8 flex flex-col items-center space-y-4">
                                ...
                                <div className="lg:flex-col flex space-x-4 lg:space-y-4 ">
                                    ...
                                    <div className="border-2 border-dashed border-gray-400 text-center px-6 py-4 rounded-lg w-48 bg-gray-50">
                                ...
                                <div className="flex space-x-4 lg:flex-col lg:space-y-4">
                                    <div className="border-2 border-dashed border-blue-500 bg-blue-50 text-center px-6 py-4 rounded-lg w-80 shadow-sm">
                                        ...
                                        <button className="text-blue-600 underline text-sm hover:text-blue-800 transition-colors" onClick={handleSignatureClick}>
                                            Click to sign
                                        </button>
                                    </div>
                                    <div className="border-2 border-dashed border-blue-500 bg-blue-50 text-center px-6 py-4 rounded-lg w-48 shadow-sm">
                                        <div className="font-medium text-blue-700 mb-1">Date</div>
                                        <div className="text-gray-800 mb-2">John Doe</div>
                                        <button className="text-blue-600 underline text-sm hover:text-blue-800 transition-colors" onClick={handleDateClick}>
                                            Click to sign
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div className="bg-white rounded-lg shadow-xl w-[600px] max-h-[90vh] overflow-y-auto">
                                    ...
                                    <div className="flex items-center justify-between p-4 border-b border-gray-200">
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-600 mt-1">Signing as: John Doe (tenant)</p>
                                        </div>
                                        <button
                                    ...
                                    <div className="flex border-b border-gray-200">
                                        <button
                                            ...
                                            className={`flex items-center space-x-2 px-4 py-3 text-sm font-medium border-b-2 ${signatureTab === 'draw'
                                        ...
                                        <button
                                            ...
                                            className={`flex items-center space-x-2 px-4 py-3 text-sm font-medium border-b-2 ${signatureTab === 'type'
                                                ? 'border-blue-500 text-blue-600 bg-blue-50'
                                                : 'border-transparent text-gray-600 hover:text-gray-800'
                                                }`}
                                        >
                                        ...
                                        {signatureTab === 'draw' ? (
                                            ...
                                            <div>
                                                <input
                                                    ...
                                                    className="w-full h-20 text-2xl text-center border-2 border-dashed border-gray-300 rounded-lg bg-gray-50 focus:outline-none focus:border-blue-500 font-script"
                    ...
                    {showDateModal && (
                        <div className="fixed inset-0  bg-opacity-40 backdrop-blur-sm flex items-center justify-center z-50">
                            <div className="bg-white rounded-lg shadow-xl w-[460px] max-h-[90vh] overflow-y-auto">
                                {/* Modal Header */}
                                <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200">
                                    <h3 className="text-lg font-semibold text-gray-900">Add Date</h3>
                                    <button
                                        onClick={handleCloseModal}
                                        className="text-gray-500 hover:text-gray-700"
                                    >
                                ...
                                <div className="px-6 py-6 space-y-4">
                                    ...
                                    <div className="bg-blue-100 border border-blue-200 rounded-md px-4 py-3">
                                        <p className="text-sm text-blue-800 font-medium mb-1">Today Date:</p>
                                    ...
                                    <div className="flex justify-between pt-2">
                                        <button
                                            onClick={handleCloseModal}
                                            className="px-5 py-2 text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-md text-sm"
                                        >
                                            Cancel
                                        </button>
                                        <button
                                            onClick={handleCloseModal}
                                            className="px-5 py-2 bg-green-600 text-white hover:bg-green-700 rounded-md text-sm flex items-center gap-2"
                                        >
                            ...
                            <div className="p-4 space-y-4">
                                {parties.map((person) => (
                                    ...
                                    >
                                        ...
                                        <p className="text-xs text-gray-600 mb-2">{person.email}</p>
                                        {person.required ? (
